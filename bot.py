...
DISCORD_TOKEN = os.getenv('DISCORD_TOKEN', 'MTUxNjUyMTYyOTM5ODcyODc4NQ.GHyyI_.0NbdwRsvsd_JyQkz8MCvP9wCnytmV0zwjViBfg')
BOT_NAME = os.getenv('BOT_NAME', 'PhoenixBot')
PREFIX = os.getenv('PREFIX', '!')
YOUR_SERVER_IP = os.getenv('YOUR_SERVER_IP', '127.0.0.1')
MAIN_ADMIN_ID = int(os.getenv('MAIN_ADMIN_ID', '1391705452240437290'))
VPS_USER_ROLE_ID = int(os.getenv('VPS_USER_ROLE_ID', '1391705452240437290'))
...
if __name__ == "__main__":
    if DISCORD_TOKEN:
        ...
        logger.error("No Discord token found in DISCORD_TOKEN environment variable.")ariable.")
