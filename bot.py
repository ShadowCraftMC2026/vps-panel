...
BOT_STATUS_NAME = os.getenv('BOT_STATUS_NAME', 'PhoenixNode')
WATERMARK = os.getenv('WATERMARK', 'Powered by PhoenixNode VPS Bot')
...
VPS_HOSTNAME = os.getenv('VPS_HOSTNAME', 'phoenix-free')  # Base hostname, append user ID
